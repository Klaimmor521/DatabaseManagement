        ...
        static void CreateDatabaseAndTables()
        {
            ...
            BEGIN
                CREATE TABLE Library (
                    ...
                    UserId INT NOT NULL,                     
                    GameId INT NOT NULL,                     
                    CONSTRAINT FK_Library_User FOREIGN KEY (UserId) REFERENCES User(UserId) ON DELETE CASCADE,
            ...
            BEGIN
                CREATE TABLE Friendship (
                    ...
                    CONSTRAINT FK_Friendship_User1 FOREIGN KEY (UserId1) REFERENCES User(UserId) ON DELETE CASCADE,
                    CONSTRAINT FK_Friendship_User2 FOREIGN KEY (UserId2) REFERENCES User(UserId) ON DELETE CASCADE
                );
            END;
